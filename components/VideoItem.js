...
return (
    <div>
        ...
        <div class="aspect-w-16 aspect-h-9">
            <iframe src={video} width="470" height="360" frameborder="0" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen></iframe>
        </div>
            ...
            <div class="flex border-t border-gray-700 w-full py-4">
              ...
              <div class="flex items-center flex-shrink-0 px-2">
                ...
                <div className="grid grid-cols-3 gap-4 pt-5">
                    <iframe src={video} width="340" height="240" frameborder="0" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen></iframe>
