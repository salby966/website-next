...
import Styles from "../styles/Keunggulan.module.css";

export default function KeunggulanSection(){
    return(
    <div className={Styles.header, Styles.body}>
    <div className={Styles.section}>
        <div className={Styles.oop}></div>
        <div className={Styles.fixed}>
            <h1 className={Styles.large}>Parallax Background</h1>
